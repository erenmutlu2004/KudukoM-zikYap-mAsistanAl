while ($true) {
    ...
    switch ($komut.ToLower()) {
        ...
        "pil seviyesi kaç"         { (Get-WmiObject -Class Win32_Battery).EstimatedChargeRemaining }
...
Start-Process $url }     
    ...
    Start-Sleep -Milliseconds 100
	  ...
	  "suno aç"  { Start-Process "https://suno.com/home?utm_source=google&utm_medium=cpc&utm_campaign=GF_Pmax_Prospecting_Signups_INT_Low-Tier&utm_term=&utm_content=&gad_source=1&gclid=Cj0KCQjwtpLABhC7ARIsALBOCVqInARK36-Y9ePTIQTQUcQ8Sro-HnmiCF-kqPE8RdPgqe2BWnAgV2oaAu5kEALw_wcB" }
	...
	"google gmail aç"    { Start-Process "https://mail.google.com/" }								                      
        "google kitaplar aç"        { Start-Process "https://books.google.com" }																																				"bedava film aç"        { Start-Process "https://kudukomuzikyapim.blogspot.com/p/izlenecek-yabanc-filmler.html" }																															"youtube müzik aç"        { Start-Process "https://music.youtube.com" }																																					"edge tarayıcı aç"   { Start-Process "msedge" }																																									"web site aç"        { Start-Process "https://kudukomuzikyapim.blogspot.com" }             
        																							"kaç adet uygulama yüklü aç" { (Get-StartApps).Count } 																																								"kaç adet uygulama yüklü listesini aç" { Get-StartApps | Select-Object Name }																																				"store aç"           { Start-Process "ms-windows-store:" }										                                                                                                                                          																							"mağaza aç"          { Start-Process "https://kudukomuzikyapim.company.site" }            
                                                                                                                                                   																												"asistan al aç"      { Start-Process "https://kudukomuzikyapim.blogspot.com/p/kuduko-muzik-yapm-assistan.html" }				                                                                                                                                          																							"youtube kanala abone ol aç"      { Start-Process "https://www.youtube.com/@KudukoMüzikYapım.Official" }	                       																																																				"instagram hesab takip et aç"      { Start-Process "https://www.instagram.com/erenmutlu.kuduko.official/" }	                                                                                                                                                   																																														"facebook hesab takip et aç"      { Start-Process "https://www.facebook.com/erenmutlu.kuduko.official/" }																																																							"tiktok hesab takip et aç"      { Start-Process "https://www.tiktok.com/@kudukomuzikyapim" }																																																									"google hesab takip et aç"      { Start-Process "https://g.co/kgs/K2if5XW" }																																																											"linktree hesab takip et aç"    { Start-Process "https://linktr.ee/erenmutlu0bozkurtlar1kuduko?fbclid=PAZXh0bgNhZW0CMTEAAad5-AmeXSWA1iaat3zIm2KDH_iz2I-RV1uPphERmbydXE8uhhDTHiHVUQ04bw_aem_t-Phu614_CK5K3912cz4mQ" }																																							"kamera aç"          { Start-Process "microsoft.windows.camera:" }									             
